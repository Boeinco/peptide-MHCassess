...
Note that for producing figures, PCA and UMAP approximations are within 0.9 correlation so can be replaced using PCA_peps.R file if computational time for UMAP is too high.
